...
import { Form, Button, Alert, Container, Spinner, Image } from "react-bootstrap";
    ...
    useEffect(() => {
        const handleMount = async () => {
            ...
            try {
                ...
                currentUserProfile ? setProfileData({ member, household_name, role, image }) : history.push('/')
            } catch (err) {
                console.log(err)
            }            
        }
			...
			<Form onSubmit={handleSubmit}>
              ...
              <Form.File
				...
				<Form.Group controlId="role">
					<Form.Label className={styles.Label}>Your role in the household</Form.Label>
					<Form.Control
						as='select'
